...
# Use the specified path for system_prompt.txt
system_prompt_path = Path("/Users/alexdeane/AI Project/system_prompt.txt")
print(f"Looking for system_prompt.txt at: {system_prompt_path}")
